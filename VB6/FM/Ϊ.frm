...
Begin VB.Form Form1 
   ...
   Begin VB.OLE OLE3 
      ...
      Height          =   255
      Left            =   8400
      SourceDoc       =   "D:\DESKTOP\MINE\FM\TEMP.vsd"
      TabIndex        =   21
      Top             =   1080
      Width           =   255
   End
   Begin VB.OLE OLE2 
      ...
      Height          =   255
      Left            =   7920
      OleObjectBlob   =   "з.frx":19DE
      SourceDoc       =   "D:\DESKTOP\MINE\FM\TEMP.doc"
      TabIndex        =   20
      Top             =   1080
      Width           =   255
   End
   Begin VB.OLE OLE1 
      ...
      Height          =   255
      Left            =   7440
      OleObjectBlob   =   "з.frx":9FF6
      SourceDoc       =   "D:\DESKTOP\MINE\FM\TEMP.xls"
      TabIndex        =   19
      Top             =   1080
      Width           =   255
   End
...
Dim db10 As New ADODB.Connection
Dim rs10 As ADODB.Recordset

db10.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
"Data Source=" & "\DB.mdb" & ";" & _
      "Persist Security Info=False"
db10.Open App.Path & "\DB.mdb"

Set rs10 = db10.Execute("SELECT count(*) FROM PIN where severity='" & Combo1.Text & "'")
Label10.Caption = rs10.Fields(0).Value
...
db11.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
"Data Source=" & "\DB.mdb" & ";" & _
      "Persist Security Info=False"
db11.Open App.Path & "\DB.mdb"

Set rs11 = db11.Execute("SELECT count(*) FROM PIN")
Label9.Caption = rs11.Fields(0).Value
...
Set rs10 = db10.Execute("SELECT count(*) FROM PIN")
Label9.Caption = rs10.Fields(0).Value
...
Private Sub Command19_Click()
   ...
   Dim r As Long
   r = ShellExecute(0, "open", "https://techsupport.cdialogues.com/tasks/main/tasks/list", 0, 0, 1)
...
Private Sub Command20_Click()
   Dim r As Long
   r = ShellExecute(0, "open", "http://liveinfo.cdialogues.com/support/", 0, 0, 1)
...
Dim DATABASE_FILE2 As String
DATABASE_FILE2 = App.Path & "/DB.MDB"
Adodc3.ConnectionString = _
"PROVIDER=Microsoft.Jet.OLEDB.4.0;" & _
"Data Source=" & DATABASE_FILE2 & ";"
Adodc3.RecordSource = "SELECT count(*) FROM PIN"
' Bind the ADODC to the DataGrid.
Set DataGrid3.DataSource = Adodc3
Label9.Caption = DataGrid3.Columns(0).Text
...
Dim DATABASE_FILE3 As String
DATABASE_FILE3 = App.Path & "/DB.MDB"
Adodc4.ConnectionString = _
"PROVIDER=Microsoft.Jet.OLEDB.4.0;" & _
"Data Source=" & DATABASE_FILE3 & ";"
Adodc4.RecordSource = "SELECT count(*) FROM PIN"
' Bind the ADODC to the DataGrid.
Set DataGrid4.DataSource = Adodc4
Label10.Caption = DataGrid4.Columns(0).Text
...
Select Case Combo1.Text
    Case "1S"
        Label8.Caption = "Default"
    Case "2S"
        Label8.Caption = "NAGIOS_MONITORING"
    Case "3D"
        Label8.Caption = "IT_BASEIS_SYSTEM"

    Case "4M"
        Label8.Caption = "OPERATION_PROMOS_OBSERVATION"
    
    Case "5K"
        Label8.Caption = "PERSONAL_SUPPORT"

    Case "6L"
        Label8.Caption = "BUSSINESS_DEV_PALE"
    
    Case "7N"
        Label8.Caption = "DEPLOYMENTS - CUSTOMER ISSUES - TESTING_QA"

    Case "8N"
        Label8.Caption = "GENERAL_FUTURE"
    
    Case "9PENDING"
        Label8.Caption = "watch status"
