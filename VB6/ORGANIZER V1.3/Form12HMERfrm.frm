...
Begin VB.Form Form12HMER 
   BackColor       =   &H80000013&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "амтийатастасг амтицяажым глеяокоциоу"
   ClientHeight    =   10500
   ClientLeft      =   90
   ClientTop       =   450
   ClientWidth     =   15180
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H80000013&
      Caption         =   "амтийатастасг глеяокоциоу ле етгсиа амтицяажа"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   161
      ...
      Begin VB.Label Label3 
         Alignment       =   2  'Center
         BackColor       =   &H80000013&
         Caption         =   "епикенте то етгсио амтицяажо глеяокоциоу ле то опоио хекете ма амтийатастгсете то тяевом глеяокоцио"
         Height          =   495
         Left            =   120
         TabIndex        =   5
         Top             =   360
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H80000013&
      Caption         =   "амтийатастасг глеяокоциоу ле амтицяажа"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   161
      ...
      Begin VB.Label Label2 
         Alignment       =   2  'Center
         BackColor       =   &H80000013&
         Caption         =   "епикенте то амтцяажо глеяокоциоу ле то опоио хекете ма амтийатастгсете то тяевом глеяокоцио"
         Height          =   495
         Left            =   120
         TabIndex        =   4
         Top             =   360
   ...
   Begin VB.Label Label1 
      BackColor       =   &H80000013&
      Caption         =   "амтийатастасг ле амтицяажа глеяокоциоу"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   161
...
If C = 1 Then
    ...
    Text1.Text = ""
Else
    If MsgBox("сас пяотеимете емтома то ма йяатгсете ема амтицяажо дедолемым глеяокоциоу пяим пяовыягсете стгм амтийатастасг.ам дем евете йяатгсг амтицяажо тоте патгсте CANCEL йаи пгцаимете сто пяогцоулемо лемоу пяойеилемоу ма дглиоуяцгсете ема амтицяажо. ", vbOKCancel, "") = vbOK Then
    ...
    SOURCE = App.Path & "\databases\BACK_UPS\BACKUP_HMER\BACKUP_HMER\" & _
             Text1.Text & ".MDB"
    
    DESTINATION = App.Path & "\databases\HMEROLOGIO.MDB"
...
Else
    ...
    If MsgBox("ма цимеи г амтийатастасг;", vbYesNo, "пяосовг") = vbYes Then
    Dim FSO As New FileSystemObject
    SOURCE = App.Path & "\databases\BACK_UPS\BACKUP_HMER\BACKUP_HMER_ETOS\" & _
             Text2.Text & ".MDB"
