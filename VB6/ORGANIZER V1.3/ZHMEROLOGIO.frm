...
DB2.Open ZETAIRIES_DIADROMHS_BACKUP_DIAX
...
If C = 0 Then
    'MsgBox ("дем упаявоум епитацес стгм глеяолгмиа поу епикенате"), vbCritical, "пяосовг !!!"
    GoTo TELOS:
Else
    RS2.Open "[" & ASD & "]", DB2, adOpenDynamic, adLockBatchOptimistic
...
"Data Source=" & ZETAIRIES_DIADROMHS_BACKUP_DIAX_1 & ";" & _
"Persist Security Info=False"
DB2.Open App.Path & ZETAIRIES_DIADROMHS_BACKUP_DIAX_1
RS2A.Open "[ONOMATA_PINAKON]", DB2, adOpenDynamic, adLockBatchOptimistic
...
NIK1:
        ...
        Else
            RS2.Open "[" & ASD1 & "]", DB2, adOpenDynamic, adLockBatchOptimistic
