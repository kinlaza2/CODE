...
cd C:\HELIX
START ENCODING 25 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
call rm25.bat
echo FINISH ENCODING 25 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
cd C:\HELIX
START ENCODING 82 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
call rm82.bat
echo FINISH ENCODING 25 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
...
echo MOVE 25 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
move C:\HELIX\OUTPUT\25_2g.rm C:\HELIX\OUTPUT\%date%
echo MOVE 82 RM - %time% >> C:\HELIX\LOGS\DOS_LOGS\DOSLOG_%date%.TXT
move C:\HELIX\OUTPUT\82_3g.rm C:\HELIX\OUTPUT\%date%
